...
Додати актив до об'єкта МП
    ...
    aukzionua.Пошук об’єкта МП по ідентифікатору  ${username}  ${tender_uaid}
    ...
    Run Keyword And Ignore Error  aukzionua.Додати предмет МП  ${item_data}
    Run Keyword And Ignore Error  aukzionua.Scroll To And Click Element   id=btn-submit-form
    Wait Until Element Is Visible  xpath=//div[@data-test-id="tenderID"]
...
Внести зміни в об'єкт МП
    ...
    aukzionua.Пошук об’єкта МП по ідентифікатору  ${tender_owner}  ${tender_uaid}
    Click Element  xpath=//a[contains(@href, "asset/update")]
    Wait Until Element Is Visible  xpath=//form[@id="asset-form"]
...
Завантажити документ для видалення об'єкта МП
    ...
    aukzionua.Завантажити документ в об'єкт МП з типом  ${username}  ${tender_uaid}  ${file_path}  cancellationDetails


Завантажити ілюстрацію в об'єкт МП
  [Arguments]  ${username}  ${tender_uaid}  ${filepath}
  aukzionua.Завантажити документ в об'єкт МП з типом  ${username}  ${tender_uaid}  ${filepath}  illustration
...
Створити лот
  ...
  aukzionua.Пошук об’єкта МП по ідентифікатору  ${username}  ${asset_uaid}
...
Заповнити дані для першого аукціону
  ...
  aukzionua.Пошук лоту по ідентифікатору  ${username}  ${tender_uaid}
...
Завантажити ілюстрацію в лот
  [Arguments]  ${username}  ${tender_uaid}  ${filepath}
  aukzionua.Завантажити документ в лот з типом  ${username}  ${tender_uaid}  ${filepath}  illustration
...
Завантажити документ для видалення лоту
  [Arguments]  ${username}  ${tender_uaid}  ${file_path}
  aukzionua.Завантажити документ в лот з типом  ${username}  ${tender_uaid}  ${filepath}  cancellationDetails
...
Отримати посилання на аукціон для глядача
    ...
    aukzionua.Пошук Тендера По Ідентифікатору  ${viewer}  ${tender_uaid}
