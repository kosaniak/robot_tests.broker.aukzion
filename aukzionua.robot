...
Опублікувати Пропозицію
  ...
  ...  ELSE  Go To  http://test.neb.org.ua/bids/decline/${url.split('?')[0].split('/')[-1]}?token=465
  Go To  ${url}
...
Отримати посилання на аукціон для учасника
  ...
  Execute Javascript  window['url'] = null; $.get( "http://test.neb.org.ua/seller/tender/updatebid", { id: "${current_url.split("/")[-1]}"}, function(data){ window['url'] = data.data.participationUrl },'json');
